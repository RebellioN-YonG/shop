...
type RotationReq struct {
	g.Meta `path:"/backend/rotation/add" tags:"Rotation" method:"post" summary:"ur 1st rotation api"`
...
type RotationDeleteReq struct {
	g.Meta     `path:"/backend/rotation/delete" tags:"Rotation" method:"delete" summary:"delete a rotation"`
...
type RotationUpdateReq struct {
	g.Meta     `path:"/backend/rotation/update" tags:"Rotation" method:"post" summary:"update a rotation"`
...
type RotationGetListCommonReq struct {
	g.Meta `path:"/backend/rotation/list" tags:"Rotation" method:"get" summary:"get rotation list"`
